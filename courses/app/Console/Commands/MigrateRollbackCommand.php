...
class MigrateRollbackCommand extends \Illuminate\Database\Console\Migrations\RollbackCommand
{
    protected $migrator;

    protected $signature = 'tenant:migrate:rollback {--database= : The database connection to use}
