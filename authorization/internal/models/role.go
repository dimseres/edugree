...
type Role struct {
	...
	IsSystem       bool            `gorm:"default:false" json:"is_system" json:"-"`
	OrganizationId *uint           `gorm:"uniqueIndex:unique_index" json:"-"`
	Organizations  *[]Organization `gorm:"many2many:memberships" json:"-"`
